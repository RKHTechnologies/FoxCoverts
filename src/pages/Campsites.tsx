  ...
  return (
    <PageContainer>
      ...
      <Slider {...settings}>
        ...
        <CampsiteItem title="Brittania" image={"britannia"} pitchSize={"48m x 38m"} tap={182} wc={238} sleeps={0} description="Gateway can be opened up to Earl shilton site next door to provide a super site, Fire Area, Wood store near by, next to main car park"/>
